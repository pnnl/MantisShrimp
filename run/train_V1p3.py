...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_amp",type=bool,default=True,choices=[False,True])
    ...
    if LATEFUSION:
        ...
        model = LateFusionModel(BaseModel_galex,BaseModel_ps,BaseModel_unwise,num_classes=N_CLASSES )
    else:
...
#     model.fc2 = torch.nn.Linear(2048,args.n_classes)
    ...
    if WORLD_RANK==0:
        writer = SummaryWriter(log_dir='/rcfs/projects/mantis_shrimp/mantis_shrimp/tensorboardlog2/'+UUID)
    ...
    for epoch in range(1,N_EPOCHS+1):
        ...
        val_loss, MAD, BIAS, ETA = val_epoch(epoch,
                                              model,
                                              opt,
                                              valloader,
                                              loss_fn,
