...
srun torchrun --rdzv_endpoint=$head_node_ip:$free_port --nnodes=8 --nproc_per_node=2 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d  --max-restarts=2 ./train_V1p3.py --fusion_type=early
