...
srun torchrun --rdzv_endpoint=$head_node_ip:$free_port --nnodes=2 --nproc_per_node=8 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d  --max-restarts=2 ./train_V1p4.py --fusion_type=early --initial_lr=0.0003 --weight_decay=0.0000001 --hidden_width=2048 --n_classes=400 --random_seed=1
